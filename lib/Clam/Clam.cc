...
bool ClamPass::runOnModule(Module &M) {
  ...
  CrabBuilderParams params(
      CrabTrackLev, CrabCFGSimplify, true, CrabEnableUniqueScalars,
...
// execute CI_SEA_DSA
    ...
    case heap_analysis_t::CS_SEA_DSA: {
      ...
      mem.reset(new LegacySeaDsaHeapAbstraction(
          ...
          CrabUseArraySmashing, CrabDsaDisambiguateUnknown,
          CrabDsaDisambiguatePtrCast, CrabDsaDisambiguateExternal));
      CRAB_VERBOSE_IF(1, crab::get_msg_stream()
