...
void invariant_annotation::print_begin(basic_block_label_t bbl, crab::crab_os &o) const {
...
void invariant_annotation::print_end(basic_block_label_t bbl, crab::crab_os &o) const {
  if (const llvm::BasicBlock *bb = bbl.get_basic_block()) {
...
void unproven_assumption_annotation::print_begin(const statement_t &s, crab::crab_os &o) const {
...
print_block::print_block(cfg_ref_t cfg, crab::crab_os &o,
