...
// We force to scalarize everything
static cl::opt<bool> ScalarizeLoadStore(
    "scalarize-load-store", cl::init(true), cl::Hidden,
...
class ScalarizerPass : public FunctionPass {
public:
  static char ID;

  ScalarizerPass() : FunctionPass(ID) {}
  ...
  virtual StringRef getPassName() const override {
    return "Clam: Scalarize vector operations";
  }
};

char ScalarizerPass::ID = 0;

FunctionPass *createScalarizerPass() { return new ScalarizerPass(); }

} // namespace clam

static llvm::RegisterPass<clam::ScalarizerPass>
    X("scalarizer", "Scalarize vector operations");
