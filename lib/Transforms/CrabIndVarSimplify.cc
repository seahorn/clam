...
bool CrabIndVarSimplify::isValidRewrite(Value *FromVal, Value *ToVal) {
...
///   bar((double)i);
///
void CrabIndVarSimplify::HandleFloatingPointIV(Loop *L, PHINode *PN) {
...
void CrabIndVarSimplify::RewriteNonIntegerIVs(Loop *L) {
...
void CrabIndVarSimplify::RewriteLoopExitValues(Loop *L, SCEVExpander &Rewriter) {
...
///
void CrabIndVarSimplify::SimplifyAndExtend(Loop *L,
...
void CrabIndVarSimplify::SinkUnusedInvariants(Loop *L) {
...
bool CrabIndVarSimplify::runOnLoop(Loop *L, LPPassManager &LPM) 
{
