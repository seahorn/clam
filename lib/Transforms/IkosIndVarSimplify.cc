...
bool IkosIndVarSimplify::isValidRewrite(Value *FromVal, Value *ToVal) {
...
///   bar((double)i);
///
void IkosIndVarSimplify::HandleFloatingPointIV(Loop *L, PHINode *PN) {
...
void IkosIndVarSimplify::RewriteNonIntegerIVs(Loop *L) {
...
void IkosIndVarSimplify::RewriteLoopExitValues(Loop *L, SCEVExpander &Rewriter) {
...
///
void IkosIndVarSimplify::SimplifyAndExtend(Loop *L,
...
void IkosIndVarSimplify::SinkUnusedInvariants(Loop *L) {
...
bool IkosIndVarSimplify::runOnLoop(Loop *L, LPPassManager &LPM) 
{
