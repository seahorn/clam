...
struct CrabBuilderParams {
  ...
  CrabBuilderParams()
      : precision_level(crab::cfg::NUM), simplify(false), interprocedural(true),
        lower_singleton_aliases(false), memory_ssa(false),
        include_useless_havoc(true), use_array_smashing(true),
        initialize_arrays(true), aggressive_initialize_arrays(false),
        enable_bignums(false), print_cfg(false) {}

  CrabBuilderParams(crab::cfg::tracked_precision _precision_level,
                    bool _simplify, bool _interprocedural,
                    bool _lower_singleton_aliases, bool _memory_ssa,
                    bool _include_useless_havoc, bool _use_array_smashing,
                    bool _initialize_arrays, bool _aggressive_initialize_arrays,
                    bool _enable_bignums, bool _print_cfg)
      : precision_level(_precision_level), simplify(_simplify),
        ...
        memory_ssa(_memory_ssa), include_useless_havoc(_include_useless_havoc),
  ...
  bool track_pointers() const { return precision_level == crab::cfg::PTR; }
  ...
  void set_num_precision() { precision_level = crab::cfg::NUM; }

  /* Represent booleans, integers, and pointers */
  void set_pointer_precision() { precision_level = crab::cfg::PTR; }
  ...
  void enable_memory_ssa() { memory_ssa = true; }
