...
constexpr Type PK_PPLITE(13, "pk-pplite",
                         "polyhedra from PPLite (native)", true, false);
constexpr Type PK_AP_PPLITE(14, "pk-ap-pplite",
                            "polyhedra from PPLite (via Apron)", true, false);
constexpr Type SIGN_CONSTANTS(15, "sign-const", "sign+constants", false, false);
