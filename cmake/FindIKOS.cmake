if (NOT IKOS_FOUND)
  ...
  message (STATUS "Given Ikos root: ${IKOS_ROOT}")
  ...
  find_library(IKOS_TERM_LIB NAMES term PATHS ${IKOS_ROOT}/lib NO_DEFAULT_PATH)
  message (STATUS "IKOS_DBM_LIB: ${IKOS_DBM_LIB}")
  message (STATUS "IKOS_TERM_LIB: ${IKOS_TERM_LIB}")
  
  include (FindPackageHandleStandardArgs)
  find_package_handle_standard_args(IKOS REQUIRED_VARS IKOS_INCLUDE_DIR) 
  if (IKOS_FOUND)
    mark_as_advanced(IKOS_ROOT IKOS_INCLUDE_DIR IKOS_DBM_LIB IKOS_TERM_LIB)
    ...
    if (IKOS_DBM_LIB)
      ...
      set (IKOS_TERM_LIB CACHE FILEPATH "" FORCE)
    endif()
  endif()
endif()
