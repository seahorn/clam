// RUN: %crabllvm --inline  --lower-select --lower-unsigned-icmp --crab-do-not-print-invariants --crab-dom=mdd-boxes --crab-check=assert %opts "%s" 2>&1 | OutputCheck -l debug %s
