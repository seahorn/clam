// RUN: %clam --inline  --lower-select --lower-unsigned-icmp --crab-print-invariants=false --crab-dom=boxes --crab-check=assert %opts --crab-sanity-checks --llvm-pp-loops  "%s" 2>&1 | OutputCheck -l debug %s
