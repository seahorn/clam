// RUN: %crabllvm --turn-undef-nondet --inline  --lower-select --devirt-functions=types --lower-unsigned-icmp --crab-do-not-print-invariants --crab-dom=boxes --crab-check=assert --externalize-addr-taken-functions %opts --crab-sanity-checks "%s" 2>&1 | OutputCheck -l debug %s
                              ...
                              if (s->state == 4432) {
                                ...
                                if (s->state == 4433) {
                                  ...
                                  if (s->state == 4448) {
									...
									//__CRAB_assert((s->s3)->tmp.next_state >= 3);
									//__CRAB_assert((s->s3)->tmp.next_state >= 4560);
